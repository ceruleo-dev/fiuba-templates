%% -------------------------------------
%%
%% Graduate thesis cover page file.
%%
%% ---------------------
%% Change log:
...
%%
%% ---------------------
%% Filename: front-matter-cover-graduate-thesis.tex
...
\AddToShipoutPictureBG*{%
	\includegraphics[width=\paperwidth,height=\paperheight]{media/front-matter-cover/02-FIUBA-graduate-thesis-cover-background.png}%
}
...
\begin{titlepage}
	...
	\begin{minipage}[t][0.9\textheight][t]{0.8\textwidth}
		...
		% 3. DEGREE NAME
		\vspace{20bp}% 
		{\fontsize{15}{18}\selectfont [(Tesis/Trabajo Final) de la (Carrera de Especialización)/(Maestría) en (especialidad)]\par}
