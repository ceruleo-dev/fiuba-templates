...
%\include{front-matter-cover-phd-dissertation.tex}
...
% ---------------------------------------------------
\include{front-matter-signature.tex}
...
\setcounter{page}{1}
\include{main-body-chapter-intro.tex}
\include{main-body-chapter-results.tex}
\include{main-body-conclusions.tex}
% ---------------------------------------------------
% APPENDICES
% ---------------------------------------------------
\appendix
\include{back-matter-appendix-calculos-complementarios.tex}
\include{back-matter-appendix-nutation-theory-coefficients.tex}
...
% ---------------------------------------------------
\include{back-matter-authorship-declaration.tex}
\end{document}
