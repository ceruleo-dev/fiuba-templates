%% -------------------------------------
%%
%% Undergraduate capstone (TP Profesional)/Thesis cover page file.
%%
%% ---------------------
%% Change log:
...
%%
%% ---------------------
%% Filename: front-matter-cover-undergraduate-thesis.tex
...
\AddToShipoutPictureBG*{%
	\includegraphics[width=\paperwidth,height=\paperheight]{media/front-matter-cover/01-FIUBA-undergraduate-thesis-cover-background.png}%
}
...
\begin{titlepage}
	...
	\begin{minipage}[t][0.9\textheight][t]{0.8\textwidth}
		...
		% 3. DEGREE NAME
		\vspace{20bp}% 
		{\fontsize{15}{18}\selectfont [Tesis de Grado en Ingeniería (especialidad)]\par}
